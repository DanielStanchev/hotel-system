...
public class ErrorMessages {
    ...
    public static final String NO_ROOMS_AVAILABLE = "No available rooms.";
    ...
    public static final String UNDERAGE_USER = "User must be at least 18 years old to book a room";
